...
struct Q_GUI_EXPORT QVectorData
{
    QBasicAtomicInt ref;
    int alloc;
    int size;
...
Q_TEMPLATE_EXTERN template class Q_GUI_EXPORT QVector<QPointF>;
Q_TEMPLATE_EXTERN template class Q_GUI_EXPORT QVector<QPoint>;
# pragma warning(pop)
#endif
