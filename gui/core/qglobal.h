...
Q_GUI_EXPORT const char *qVersion();
Q_GUI_EXPORT bool qSharedBuild();
...
// Q_GUI_EXPORT void qDebug(const char *, ...) /* print debug message */
...
// #ifndef Q_WARNING
// #define Q_WARNING
Q_GUI_EXPORT void qWarning(const char *, ...);
// #endif
// #if defined(Q_CC_GNU) && !defined(__INSURE__)
//     __attribute__ ((format (printf, 1, 2)))
// #endif
...
// class QString;
// Q_GUI_EXPORT QString qt_error_string(int errorCode = -1);
// Q_GUI_EXPORT void qCritical(const char *, ...) /* print critical message */
// #if defined(Q_CC_GNU) && !defined(__INSURE__)
//     __attribute__ ((format (printf, 1, 2)))
// #endif
// ;
// Q_GUI_EXPORT void qFatal(const char *, ...) /* print fatal message and exit */
// #if defined(Q_CC_GNU) && !defined(__INSURE__)
//     __attribute__ ((format (printf, 1, 2)))
// #endif
// ;
...
#ifdef QT3_SUPPORT
Q_GUI_EXPORT QT3_SUPPORT void qSystemWarning(const char *msg, int code = -1);
#endif /* QT3_SUPPORT */
Q_GUI_EXPORT void qErrnoWarning(int code, const char *msg, ...);
Q_GUI_EXPORT void qErrnoWarning(const char *msg, ...);
...
Q_GUI_EXPORT_INLINE  QDebug qDebug();
Q_GUI_EXPORT_INLINE  QDebug qWarning();
Q_GUI_EXPORT_INLINE  QDebug qCritical();
#else
...
Q_GUI_EXPORT void qt_assert(const char *assertion, const char *file, int line);
...
Q_GUI_EXPORT void qt_assert_x(const char *where, const char *what, const char *file, int line);
...
Q_GUI_EXPORT void qt_check_pointer(const char *, int);
...
Q_GUI_EXPORT void qt_message_output(QtMsgType, const char *buf);

typedef void (*QtMsgHandler)(QtMsgType, const char *);
Q_GUI_EXPORT QtMsgHandler qInstallMsgHandler(QtMsgHandler);
...
*/
Q_GUI_EXPORT void *qMalloc(size_t size);
Q_GUI_EXPORT void qFree(void *ptr);
Q_GUI_EXPORT void *qRealloc(void *ptr, size_t size);
Q_GUI_EXPORT void *qMemCopy(void *dest, const void *src, size_t n);
Q_GUI_EXPORT void *qMemSet(void *dest, int c, size_t n);
...
class Q_GUI_EXPORT QIncompatibleFlag
{
    int i;
public:
...
class QByteArray;
Q_GUI_EXPORT QByteArray qgetenv(const char *varName);
Q_GUI_EXPORT bool qputenv(const char *varName, const QByteArray& value);
...
*/
Q_GUI_EXPORT void qsrand(uint seed);
Q_GUI_EXPORT int qrand();
...
#endif
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPath();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathDocs();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathHeaders();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathLibs();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathBins();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathPlugins();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathData();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathTranslations();
QT3_SUPPORT Q_GUI_EXPORT const char *qInstallPathSysconf();
#endif
