...
class QBitRef;
class Q_GUI_EXPORT QBitArray
{
    friend Q_GUI_EXPORT QDataStream &operator<<(QDataStream &, const QBitArray &);
    friend Q_GUI_EXPORT QDataStream &operator>>(QDataStream &, QBitArray &);
    friend Q_GUI_EXPORT uint qHash(const QBitArray &key);
    QByteArray d;
...
Q_GUI_EXPORT QBitArray operator&(const QBitArray &, const QBitArray &);
Q_GUI_EXPORT QBitArray operator|(const QBitArray &, const QBitArray &);
Q_GUI_EXPORT QBitArray operator^(const QBitArray &, const QBitArray &);
