...
Q_GUI_EXPORT_INLINE  uint qHash(const QByteArray &key);
// Q_GUI_EXPORT_INLINE  uint qHash(const QString &key);
// Q_GUI_EXPORT_INLINE  uint qHash(const QStringRef &key);
Q_GUI_EXPORT_INLINE  uint qHash(const QBitArray &key);
