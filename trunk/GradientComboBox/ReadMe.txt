========================================================================
		ActiveX Control DLL : GRADIENTCOMBOBOX
========================================================================

ControlWizard has created this project for your GRADIENTCOMBOBOX ActiveX Control
...
that make up your GRADIENTCOMBOBOX ActiveX Control DLL.

GradientComboBox.dsp
...
GradientComboBox.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
GradientComboBox control:

GradientComboBoxCtl.h
	This file contains the declaration of the CGradientComboBoxCtrl C++ class.

GradientComboBoxCtl.cpp
	This file contains the implementation of the CGradientComboBoxCtrl C++ class.

GradientComboBoxPpg.h
	This file contains the declaration of the CGradientComboBoxPropPage C++ class.

GradientComboBoxPpg.cpp
	This file contains the implementation of the CGradientComboBoxPropPage C++ class.

GradientComboBoxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGradientComboBoxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GradientComboBox.rc.
