...
//     } else
// 	{
//         //modify d->state->layoutDirection = QApplication::layoutDirection();
// 		d->state->layoutDirection = Qt::LeftToRight;
...
QPainterState::QPainterState()
    : brushOrigin(0, 0), bgBrush(Qt::white), clipOperation(Qt::NoClip),
      ...
      //modify layoutDirection(QApplication::layoutDirection()),
