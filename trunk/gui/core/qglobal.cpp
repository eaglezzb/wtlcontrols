...
Q_GUI_EXPORT OSErr qt_mac_create_fsref(const QString &file, FSRef *fsref)
{
...
Q_GUI_EXPORT OSErr qt_mac_create_fsspec(const QString &file, FSSpec *spec)
{
    FSRef fsref;
...
Q_GUI_EXPORT void qt_mac_to_pascal_string(QString s, Str255 str, TextEncoding encoding=0, int len=-1)
{
    if(len == -1)
        len = s.length();
#if 0
...
Q_GUI_EXPORT QString qt_mac_from_pascal_string(const Str255 pstr) {
...
*/
Q_GUI_EXPORT unsigned int qt_int_sqrt(unsigned int n)
{
...
extern Q_GUI_EXPORT void qWinMsgHandler(QtMsgType t, const char* str);
#endif
