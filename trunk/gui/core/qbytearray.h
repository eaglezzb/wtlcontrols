...
Q_GUI_EXPORT char *qstrdup(const char *);
...
Q_GUI_EXPORT char *qstrcpy(char *dst, const char *src);
Q_GUI_EXPORT char *qstrncpy(char *dst, const char *src, uint len);

Q_GUI_EXPORT int qstrcmp(const char *str1, const char *str2);
Q_GUI_EXPORT int qstrcmp(const QByteArray &str1, const QByteArray &str2);
Q_GUI_EXPORT int qstrcmp(const QByteArray &str1, const char *str2);
...
// Q_GUI_EXPORT int qstricmp(const char *, const char *);
// Q_GUI_EXPORT int qstrnicmp(const char *, const char *, uint len);

// implemented in qvsnprintf.cpp
// Q_GUI_EXPORT int qvsnprintf(char *str, size_t n, const char *fmt, va_list ap);
// Q_GUI_EXPORT int qsnprintf(char *str, size_t n, const char *fmt, ...);
...
Q_GUI_EXPORT quint16 qChecksum(const char *s, uint len);
...
// Q_GUI_EXPORT QDataStream &operator<<(QDataStream &, const QByteArray &);
// Q_GUI_EXPORT QDataStream &operator>>(QDataStream &, QByteArray &);
// #endif

#ifndef QT_NO_COMPRESS
Q_GUI_EXPORT QByteArray qCompress(const uchar* data, int nbytes, int compressionLevel = -1);
Q_GUI_EXPORT QByteArray qUncompress(const uchar* data, int nbytes);
